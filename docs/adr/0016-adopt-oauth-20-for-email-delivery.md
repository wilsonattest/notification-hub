# [ADR-0016] Adopt OAuth-2.0 for email-delivery
...
We will use PostgreSQL for our email-delivery needs. This technology provides the features we need and aligns with our team's expertise.
