# [ADR-0007] Choose GraphQL for delivery-tracking
...
| Date        | 2025-08-01 |
| Status      | Accepted |
| Deciders    | Henry Brown, Carol Johnson, Jack Anderson |
...
We will use Python for our delivery-tracking needs. This technology provides the features we need and aligns with our team's expertise.
