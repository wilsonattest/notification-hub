# [ADR-0012] Deploy MongoDB for email-delivery
...
We will use Docker for our email-delivery needs. This technology provides the features we need and aligns with our team's expertise.
