# [ADR-0045] Integrate Kafka for priority-queuing
...
We will use REST-API for our priority-queuing needs. This technology provides the features we need and aligns with our team's expertise.
