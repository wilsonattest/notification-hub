# [ADR-0008] Implement Terraform for email-delivery
...
| Date        | 2024-03-28 |
| Status      | Superseded |
| Deciders    | Iris Taylor, Jack Anderson |
...
We will use TypeScript for our email-delivery needs. This technology provides the features we need and aligns with our team's expertise.
