# [ADR-0010] Deploy Elasticsearch for priority-queuing
...
We will use Elasticsearch for our priority-queuing needs. This technology provides the features we need and aligns with our team's expertise.
