# [ADR-0033] Migrate-to Kubernetes for notification-history
...
| Date        | 2023-04-04 |
| Status      | Superseded |
| Deciders    | Alice Chen, Frank Wilson, Jack Anderson |
...
We will use JWT for our notification-history needs. This technology provides the features we need and aligns with our team's expertise.
