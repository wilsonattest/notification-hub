# [ADR-0044] Choose Elasticsearch for priority-queuing
...
| Date        | 2024-02-02 |
| Status      | Accepted |
| Deciders    | Henry Brown, Jack Anderson, Frank Wilson |
...
We will use JWT for our priority-queuing needs. This technology provides the features we need and aligns with our team's expertise.
