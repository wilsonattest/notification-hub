# [ADR-0029] Use GraphQL for delivery-tracking
...
We will use MongoDB for our delivery-tracking needs. This technology provides the features we need and aligns with our team's expertise.
