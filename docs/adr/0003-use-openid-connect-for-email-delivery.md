# [ADR-0003] Use OpenID-Connect for email-delivery
...
| Date        | 2024-05-26 |
| Status      | Proposed |
| Deciders    | Alice Chen, Iris Taylor, Carol Johnson |
...
We will use HashiCorp-Vault for our email-delivery needs. This technology provides the features we need and aligns with our team's expertise.
