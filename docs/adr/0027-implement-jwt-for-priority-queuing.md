# [ADR-0027] Implement JWT for priority-queuing
...
We will use AWS-Lambda for our priority-queuing needs. This technology provides the features we need and aligns with our team's expertise.
