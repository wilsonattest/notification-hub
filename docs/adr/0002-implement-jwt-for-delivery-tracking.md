# [ADR-0002] Implement JWT for delivery-tracking
...
| Date        | 2025-06-20 |
| Status      | Proposed |
| Deciders    | Henry Brown, Bob Smith |
...
We will use HashiCorp-Vault for our delivery-tracking needs. This technology provides the features we need and aligns with our team's expertise.
