# [ADR-0021] Standardize-on Terraform for delivery-tracking
...
| Date        | 2025-03-27 |
| Status      | Accepted |
| Deciders    | Iris Taylor, Grace Lee, Jack Anderson |

## Context

Our delivery-tracking implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Vue.js for our delivery-tracking needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for delivery-tracking
