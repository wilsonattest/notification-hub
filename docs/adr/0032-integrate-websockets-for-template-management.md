# [ADR-0032] Integrate WebSockets for template-management
...
| Date        | 2025-03-13 |
| Status      | Accepted |
| Deciders    | Iris Taylor, Frank Wilson, Henry Brown |

## Context

Our template-management implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use PostgreSQL for our template-management needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for template-management
