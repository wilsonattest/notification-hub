# [ADR-0037] Adopt Terraform for notification-history
...
We will use PostgreSQL for our notification-history needs. This technology provides the features we need and aligns with our team's expertise.
