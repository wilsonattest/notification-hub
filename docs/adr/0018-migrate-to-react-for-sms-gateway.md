# [ADR-0018] Migrate-to React for sms-gateway
...
We will use PostgreSQL for our sms-gateway needs. This technology provides the features we need and aligns with our team's expertise.
