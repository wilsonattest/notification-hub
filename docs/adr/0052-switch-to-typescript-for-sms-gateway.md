# [ADR-0052] Switch-to TypeScript for sms-gateway
...
| Date        | 2023-09-04 |
| Status      | Superseded |
| Deciders    | Alice Chen, Bob Smith, Jack Anderson |

## Context

Our sms-gateway implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Kubernetes for our sms-gateway needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for sms-gateway
