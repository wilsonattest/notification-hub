# [ADR-0024] Choose gRPC for rate-limiting
...
We will use OAuth-2.0 for our rate-limiting needs. This technology provides the features we need and aligns with our team's expertise.
