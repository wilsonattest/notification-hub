# [ADR-0031] Switch-to Python for template-management
...
| Date        | 2024-03-03 |
| Status      | Proposed |
| Deciders    | Grace Lee, Grace Lee, Carol Johnson |
...
We will use AWS-Lambda for our template-management needs. This technology provides the features we need and aligns with our team's expertise.
