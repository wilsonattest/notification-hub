# [ADR-0036] Implement DotNet-Core for notification-history
...
We will use React for our notification-history needs. This technology provides the features we need and aligns with our team's expertise.
