# [ADR-0039] Switch-to GitHub-Actions for notification-preferences
...
| Date        | 2024-03-22 |
| Status      | Accepted |
| Deciders    | Alice Chen, Iris Taylor, Frank Wilson |

## Context

Our notification-preferences implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use React for our notification-preferences needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for notification-preferences
