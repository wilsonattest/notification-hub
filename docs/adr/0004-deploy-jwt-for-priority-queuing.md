# [ADR-0004] Deploy JWT for priority-queuing
...
| Date        | 2025-02-01 |
| Status      | Accepted |
| Deciders    | Carol Johnson, David Kim, Bob Smith |
...
We will use TypeScript for our priority-queuing needs. This technology provides the features we need and aligns with our team's expertise.
