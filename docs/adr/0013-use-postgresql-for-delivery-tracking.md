# [ADR-0013] Use PostgreSQL for delivery-tracking
...
We will use GraphQL for our delivery-tracking needs. This technology provides the features we need and aligns with our team's expertise.
