# [ADR-0054] Use Elasticsearch for batch-notifications
...
| Date        | 2024-06-10 |
| Status      | Superseded |
| Deciders    | Jack Anderson, David Kim, Carol Johnson |

## Context

Our batch-notifications implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Kubernetes for our batch-notifications needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for batch-notifications
