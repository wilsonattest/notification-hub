# [ADR-0011] Adopt Python for rate-limiting
...
| Date        | 2023-07-12 |
| Status      | Accepted |
| Deciders    | Bob Smith, Grace Lee, Bob Smith |

## Context

Our rate-limiting implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use PostgreSQL for our rate-limiting needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for rate-limiting
