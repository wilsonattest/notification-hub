# [ADR-0046] Switch-to OAuth-2.0 for email-delivery
...
We will use Redis for our email-delivery needs. This technology provides the features we need and aligns with our team's expertise.
