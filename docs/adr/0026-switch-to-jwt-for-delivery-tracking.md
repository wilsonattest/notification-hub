# [ADR-0026] Switch-to JWT for delivery-tracking
...
We will use Kafka for our delivery-tracking needs. This technology provides the features we need and aligns with our team's expertise.
