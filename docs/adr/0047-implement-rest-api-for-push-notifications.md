# [ADR-0047] Implement REST-API for push-notifications
...
| Date        | 2024-01-05 |
| Status      | Superseded |
| Deciders    | Bob Smith, Iris Taylor, Frank Wilson |

## Context

Our push-notifications implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Kafka for our push-notifications needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for push-notifications
