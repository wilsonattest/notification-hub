# [ADR-0040] Standardize-on Terraform for in-app-messaging
...
| Date        | 2023-05-08 |
| Status      | Accepted |
| Deciders    | Henry Brown, Grace Lee |

## Context

Our in-app-messaging implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use MongoDB for our in-app-messaging needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for in-app-messaging
