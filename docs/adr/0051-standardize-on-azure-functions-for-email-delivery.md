# [ADR-0051] Standardize-on Azure-Functions for email-delivery
...
| Date        | 2025-10-24 |
| Status      | Accepted |
| Deciders    | Henry Brown, Eva Martinez, Grace Lee |

## Context

Our email-delivery implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use GraphQL for our email-delivery needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for email-delivery
