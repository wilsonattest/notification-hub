# [ADR-0015] Adopt Python for sms-gateway
...
| Date        | 2023-04-26 |
| Status      | Accepted |
| Deciders    | Bob Smith, David Kim, Jack Anderson |
...
We will use GitHub-Actions for our sms-gateway needs. This technology provides the features we need and aligns with our team's expertise.
