# [ADR-0017] Implement Vue.js for webhook-delivery
...
| Date        | 2025-07-17 |
| Status      | Proposed |
| Deciders    | Grace Lee, Carol Johnson, Jack Anderson |

## Context

Our webhook-delivery implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Kafka for our webhook-delivery needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for webhook-delivery
