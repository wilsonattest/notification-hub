# [ADR-0053] Implement DotNet-Core for priority-queuing
...
| Date        | 2025-06-12 |
| Status      | Accepted |
| Deciders    | Henry Brown, Frank Wilson, Frank Wilson |
...
We will use React for our priority-queuing needs. This technology provides the features we need and aligns with our team's expertise.
