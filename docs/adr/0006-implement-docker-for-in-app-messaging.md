# [ADR-0006] Implement Docker for in-app-messaging
...
We will use React for our in-app-messaging needs. This technology provides the features we need and aligns with our team's expertise.
