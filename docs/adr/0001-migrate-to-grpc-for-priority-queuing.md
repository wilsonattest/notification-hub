# [ADR-0001] Migrate-to gRPC for priority-queuing
...
| Date        | 2025-05-15 |
| Status      | Accepted |
| Deciders    | David Kim, Henry Brown, Carol Johnson |

## Context

Our priority-queuing implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use HashiCorp-Vault for our priority-queuing needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for priority-queuing
