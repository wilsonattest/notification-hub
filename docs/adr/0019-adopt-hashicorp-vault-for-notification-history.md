# [ADR-0019] Adopt HashiCorp-Vault for notification-history
...
| Date        | 2024-01-21 |
| Status      | Superseded |
| Deciders    | Frank Wilson, Jack Anderson, Frank Wilson |
...
We will use Azure-Functions for our notification-history needs. This technology provides the features we need and aligns with our team's expertise.
