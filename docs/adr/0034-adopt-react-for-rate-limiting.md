# [ADR-0034] Adopt React for rate-limiting
...
| Date        | 2025-11-13 |
| Status      | Deprecated |
| Deciders    | Carol Johnson, Eva Martinez |
...
We will use Python for our rate-limiting needs. This technology provides the features we need and aligns with our team's expertise.
